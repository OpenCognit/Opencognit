...
import { Sparkles, ChevronDown, ChevronUp, Terminal, Shield, Wrench, UserCheck, BookOpen, CheckCircle2, Globe, Search } from 'lucide-react';
...
import { ModalShell, FieldLabel, inputStyle, inputFocus, textareaStyle, btnPrimary, btnPrimaryHover, btnSecondary, btnSecondaryHover, btnDanger, btnDangerHover, ErrorBox } from './ModalShell';
              ...
              {verbindung === 'anthropic' && (
                <div style={{ backgroundColor: 'rgba(197, 160, 89, 0.05)', border: '1px solid rgba(197, 160, 89, 0.1)', borderRadius: 0, padding: '1rem' }}>
                  ...
                  <select
                    value={modell}
                    onChange={e => setModell(e.target.value)}
                    style={{ width: '100%', padding: '0.5rem 0.75rem', backgroundColor: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 0, fontSize: '0.875rem', color: 'var(--color-text-primary)', cursor: 'pointer' }}
                  >
