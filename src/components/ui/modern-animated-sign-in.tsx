...
import { Eye, EyeOff, Code2, Palette, Terminal, GitBranch, Figma, Smartphone, Cloud, Cpu } from 'lucide-react';
...
export const defaultTechIcons: IconConfig[] = [
  {
  ...
  {
    icon: <Cpu className='h-7 w-7 text-red-500' />,
    className: 'size-[50px] border-none bg-transparent',
    radius: 240,
    duration: 30,
    delay: 40,
