...
CREATE TABLE IF NOT EXISTS estimate_material_components (
    ...
    menge_pro_einheit REAL NOT NULL DEFAULT 1,
    einheitspreis   REAL NOT NULL DEFAULT 0,
    zeilenpreis     REAL NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS estimate_labour_components (
    ...
    menge_pro_einheit REAL NOT NULL DEFAULT 1,
    output_pro_tag  REAL,
    labour_days     REAL NOT NULL DEFAULT 1,
    tagessatz       REAL NOT NULL DEFAULT 0,
    zeilenpreis     REAL NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS estimate_equipment_components (
    ...
    stunden_pro_tag REAL DEFAULT 8,
    equipment_days  REAL NOT NULL DEFAULT 1,
    zeilenpreis     REAL NOT NULL DEFAULT 0,
    source          TEXT DEFAULT 'manual',
    sort_order       INTEGER NOT NULL DEFAULT 0,
    erstellt_am      TEXT NOT NULL DEFAULT (datetime('now')),
...
CREATE TABLE IF NOT EXISTS estimate_rate_summaries (
    ...
    subcontract_total   REAL NOT NULL DEFAULT 0,
    ...
    risk_allowance_pct  REAL NOT NULL DEFAULT 0,
    risk_allowance_amount REAL NOT NULL DEFAULT 0,
