-- =============================================================================
-- Migration 0046: PR-SRCH-1 — Universal Search Index Foundation
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS search_index_records (
    ...
    last_indexed_am     TEXT NOT NULL DEFAULT (datetime('now')),
...
CREATE TABLE IF NOT EXISTS search_recent_items (
    ...
    record_type     TEXT NOT NULL,
    title           TEXT NOT NULL,
    accessed_am     TEXT NOT NULL DEFAULT (datetime('now'))
);
