...
CREATE TABLE IF NOT EXISTS equipment_categories (
    ...
    typical_rate_per_day DOUBLE PRECISION,
...
INSERT INTO equipment_categories ON CONFLICT (id) DO NOTHING (id, name, class, required_safety_check, fuel_required) VALUES
...
CREATE TABLE IF NOT EXISTS equipment_assets (
    ...
    meter_reading   DOUBLE PRECISION DEFAULT 0,
    meter_unit      TEXT DEFAULT 'hours',
    hire_rate_per_day DOUBLE PRECISION,
    base_location    TEXT,
    erstellt_am     TEXT NOT NULL DEFAULT (NOW()),
...
CREATE TABLE IF NOT EXISTS equipment_allocations (
    ...
    work_pack_id    TEXT,
    allocated_am    TEXT NOT NULL DEFAULT (NOW()),
    released_am     TEXT,
...
CREATE TABLE IF NOT EXISTS equipment_operator_assignments (
    ...
    assigned_am     TEXT NOT NULL DEFAULT (NOW()),
    released_am     TEXT,
    status          TEXT NOT NULL DEFAULT 'active',
    erstellt_von    TEXT NOT NULL,
    erstellt_am     TEXT NOT NULL DEFAULT (NOW())
