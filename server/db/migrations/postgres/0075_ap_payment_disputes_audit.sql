...
CREATE TABLE IF NOT EXISTS service_confirmations (
    ...
    period_start    TEXT,
    period_end      TEXT,
    confirmed_days  DOUBLE PRECISION NOT NULL DEFAULT 0,
    confirmed_units DOUBLE PRECISION,
    confirmed_by    TEXT NOT NULL,
    confirmed_am    TEXT NOT NULL DEFAULT (NOW()),
...
CREATE TABLE IF NOT EXISTS vendor_disputes (
    ...
    description     TEXT NOT NULL,
    amount_disputed DOUBLE PRECISION DEFAULT 0,
    status          TEXT NOT NULL DEFAULT 'open',
    resolution      TEXT,
    resolved_by     TEXT,
    resolved_am     TEXT,
...
CREATE TABLE IF NOT EXISTS ap_audit_events (
    ...
    old_value        TEXT,
    new_value        TEXT,
    event_am        TEXT NOT NULL DEFAULT (NOW()),
    erstellt_am     TEXT NOT NULL DEFAULT (NOW())
);
